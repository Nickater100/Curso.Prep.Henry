...
function tienenMismaLongitud(str1, str2) {
  ...
  // De lo contrario, devuelve "false"
  // Tu código: tienenMismaLongitud("perro", "gato")
...
function mayorQueCincuenta(num) {
  ...
  // De lo contrario, devuelve "false"
  // Tu código: mayorQueCincuenta(84)
...
function redondearHaciaArriba(num) {
  ...
  // Tu código: redondearHaciaArriba(8.2)
...
function agregarSimboloExclamacion(str) {
  ...
  // Tu código: agregarSimboloExclamacion("perro")
...
function combinarNombres(nombre, apellido) {
  ...
  // Tu código: combinarNombres("Nico", "suasnavar")
...
function obtenerAreaRectangulo(alto, ancho) {
  ...
  // Tu código: obtenerAreaRectangulo(15, 5)
...
function retornarPerimetro(lado){
  ...
  //Escribe tu código aquí retornarPerimetro(4)
...
function areaDelTriangulo(base, altura){
  ...
  //Escribe tu código aquí areaDelTriangulo(5, 4)
...
function deEuroAdolar(euro){
  ...
  //Escribe tu código aquí deEuroAdolar(5)
...
function esVocal(letra){
  ...
  } else if (letra.length > 2) { return "Dato incorrecto";
